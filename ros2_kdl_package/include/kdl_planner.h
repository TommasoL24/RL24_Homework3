...
public:
    ...
    //////////////////////////////////
    void trapezoidal_vel(double time, double time_c, double& s, double& s_dot, double& s_ddot);
    ...
    trajectory_point compute_trajectory_circle(double time, double time_c=0);
    KDLPlanner(double _trajDuration, Eigen::Vector3d _trajInit, Eigen::Vector3d _trajEnd);
    trajectory_point compute_trajectory_linear(double time, double time_c=0);
